...
export default function MainHeader() {
  return (
    <div className="main-header-holder">
      <div className="main-header-logo"><img src={figmaLogo} alt="figma-logo" /></div>
      <p className="main-header-text">
        <span>Welcome to Figma!</span>Create an account to edit and collaborate
        on this file.
      </p>
      <button className="btn-text"><img src={img} alt="google-icon" height={20} fontWeight={100}/> Continue with Google</button>
